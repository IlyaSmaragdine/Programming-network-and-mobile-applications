...
import com.example.weather_app.Utilites.ApiUtilities
...
class MainActivity : AppCompatActivity() {
    ...
    private val apiKey="05e75537af6a0468c07690ec00a8f674"
    ...
    private fun fetchCurrentLocationWeather(latitude: String, longitude: String) {
        ...
        ApiUtilities.getApiInterface()?.getCurrentWeatherData(latitude,longitude,apiKey)?.enqueue(object :Callback<WeatherModel>{
            @RequiresApi(Build.VERSION_CODES.O)
            override fun onResponse(call: Call<WeatherModel>, response: Response<WeatherModel>) {
